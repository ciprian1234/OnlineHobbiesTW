<!DOCTYPE html>
<html>
<head><title>Articol Template</title>
<meta charset="UTF-8">
...
<main class="col-10 col-m-10" style="margin-left: 9%;">
  ...
  <div class="col-11 article">
	  <img class="col-3 articleImage" src="resources/images/cpp.png" alt="Mountain View" />
	  <h2>Article</h2>
	  <h3>Rating</h3>
...
<form class="articleForm " action="submit_post.php" method="post">
    ...
    <div>
        ...
        <input class="col-11 formItem" type="text" name="title" placeholder="Please enter article title..." size="50" maxlength="50">
    </div>
    ...
    <div>
        ...
        <textarea class="col-11 formItem" name="content" rows="20" placeholder="Please enter article content..."></textarea>
    </div>

    <input class="formButton col-2" type="submit" name="submit" value="Submit Comment">
