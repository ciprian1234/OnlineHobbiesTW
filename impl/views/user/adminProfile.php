...
<main class="col-10 col-m-10 mainPage">
    <div class="section">
        ...
        <div class="toggleDiv statisticsDiv">
            <h2>Statistics:</h2>
        ...
        <div class="toggleDiv createCategoryDiv">
            <form class="col-10 col-m-10 articlePreview articleForm" action="<?php echo URL . 'user/createCategory'; ?>"
                  method="post" enctype="multipart/form-data">
                <div>
                    <label class="col-3">Category title:</label>
                    <input class="col-10 col-m-10 formItem" type="text" name="title"
        ...
        <div class="toggleDiv createHobbyDiv">
            <form class="col-10 col-m-10 articlePreview articleForm" action="<?php echo URL . 'user/createHobby'; ?>"
                  method="post" enctype="multipart/form-data">
                <div>
                ...
                <textarea class="col-10 col-m-10 formItem descriptionArea" name="content" rows="30"
