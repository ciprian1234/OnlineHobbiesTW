        ...
        <div class="col-3-offset col-7 col-m-7 toggleDiv">
            <form class="articleForm" action="<?php echo URL . 'hobbies/addPreference'; ?>" method="post"
                ...
                <div>
                    ...
                    <?php
                    echo '<select class="col-2" id="hobby" name="hobby">';
                    echo '<option value=""></option>';
                    foreach ($articles as $hobby)
                        echo '<option value="' . $hobby->getId_hobby() . '">' . $hobby->getTitle() . '</option>';
                    echo '</select>';
                    ?>
                    <input class="col-6 col-m-6" type="text" name="motiv" placeholder="Motivul pentru care iti place acest hobby">
                    <div class="col-10"></div>
                    <label class="col-5 col-m-2">Share to facebook</label>
                    <input class="col-2 col-m-1 checkBox" type="checkbox" name="shareToFacebok" id="shareToFacebook">
